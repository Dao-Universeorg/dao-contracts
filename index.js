...
const DNS = require('./build/contracts/DNS')
const DNSRegistry = require('./build/contracts/DNSRegistry')
const DNSRegistryWithFallback = require('./build/contracts/DNSRegistryWithFallback')

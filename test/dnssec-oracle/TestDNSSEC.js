...
// When the real test start failing due to ttl expiration, you can generate the new test dataset at https://dnssec.dao.domains/?domain=ethlab.xyz&mode=advanced
const test_rrsets = [
  ...
  // _dns.ethlab.xyz. (here dao= dns)	21599	IN	RRSIG	TXT 8 3 86400 20340214222653 20190305212653 42999 ethlab.xyz. cK9JLb6gBKY7oJi2E+94a0Eii8k4nirIKgginKID3FD7B0lVn6I0499nKzLVCWQtFc3Hnte9JaUrz4GvP3mBTA==
  // _dns.ethlab.xyz.	(here dao= dns) 21599	IN	TXT	"a=0xfdb33f8ac7ce72d7d4795dd8610e323b4c122fbb"
  [
    web3.utils.toHex('_dns.ethlab.xyz.'), // (here dao= dns)
